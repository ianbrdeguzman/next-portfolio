    ...
    return (
        <header>
            <div className='p-4 md:px-8 dark:bg-gray-900 text-gray-900 flex justify-end align-center'>
                ...
                <button
                    onClick={toggleTheme}
                    className='cursor-pointer p-2 bg-transparent dark:bg-transparent dark:hover:bg-gray-100 dark:bg-gray-700 rounded focus:outline-none focus:ring focus:ring-blue-700 transition active:bg-transparent'
                >
                    {theme === 'light' ? '🌑' : '🌞'}
                </button>
            </div>
